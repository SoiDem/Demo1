...
import com.learning.serviceImpl.VietnameseLanguageImpl;
...
public class ApplicationContextConfig implements WebMvcConfigurer {
    ...
    @Bean
    public SpringResourceTemplateResolver templateResolver() { //cau hinh chay html
    ...
    * */
    @Bean
    public SpringTemplateEngine templateEngine() { /*cau  hinh template moi co the hieu dc  <html xmlns:layout="http://www.ultraq.net.nz/thymeleaf/layout"
    ...
    * */
    ...
    @Bean(name = "tienganh")
    public LanguageService getLanguageServiceEL() {
        LanguageService s = new EnglishLanguageImpl();
        return s;
    }


    @Bean(name = "tiengviet")
    public LanguageService getLanguageServiceVN() {
        LanguageService a=new VietnameseLanguageImpl();
        return  a;
